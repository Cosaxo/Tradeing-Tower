  ...
  return (
    <>
      <button
        ...
        className="relative text-[10px] font-mono px-2 py-1 rounded border border-gray-700 text-gray-400 hover:text-gray-200 hover:border-gray-500 transition-colors"
